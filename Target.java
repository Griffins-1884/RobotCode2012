...
public class Target {
    ...
    static EllipseDescriptor ellipseDescriptor = new EllipseDescriptor(
            /* minMajorRadius */   3,
            /* maxMajorRadius */ 200,
            /* minMinorRadius */   3,
            /* maxMinorRadius */ 100);

    static CurveOptions curveOptions = new CurveOptions(
            /* extractionMode */   0,
            /* threshold */       40,
            /* filterSize */       1,
            /* minLength */       25,
    ...
    static ShapeDetectionOptions shapeOptions = new ShapeDetectionOptions(
            ShapeDetectionOptions.IMAQ_GEOMETRIC_MATCH_SHIFT_INVARIANT,
            /* angleRanges */     0,
            /* numAngleRanges */  0,
            /* scaleRangeMin */  75,
            /* scaleRangeMax */ 125,
