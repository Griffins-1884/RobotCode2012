...
public class RectangleMatch {
	...
	public RectangleMatch(BinaryImage image, int index) throws NIVisionException {
		...
		orientation = NIVision.MeasureParticle(image.image, index, false, NIVision.MeasurementType.IMAQ_MT_ORIENTATION);
	}
